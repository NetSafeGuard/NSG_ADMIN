...
export const GroupsPage = () => {
  ...
  const renameGroup = (groupname: string) => (data: CreateGroup) => {
	...
	const { register, handleSubmit, watch, reset } = useForm<CreateGroup>({
									...
									<>
										...
										<Dialog open={open2} onOpenChange={setOpen2}>
											<DialogTrigger asChild>
												<div
													className="w-6"
													onClick={() => setEditedGroupName(group.name)}>
													<GoPencil
														size={12}
											...
											<DialogContent className="sm:max-w-[425px]">
												<DialogHeader>
													...
													<DialogDescription>
														Edite o nome do grupo. Clique em Editar para
														salvar as alterações.
													</DialogDescription>
												</DialogHeader>
												<form
													onSubmit={handleSubmit3(
														renameGroup(editedGroupName!),
													)}>

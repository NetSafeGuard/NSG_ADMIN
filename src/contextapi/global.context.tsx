		...
		api
			...
			.then(() => {
				...
				toast.success("Recuperação enviada", {
					description: `A sua recuperação foi enviada para o e-mail ${email}.`,
					duration: 5000,
				});
			})
			.catch((error) => {
			...
			api
				...
				.then((response) => {
					...
					toast.success("Utilizador criado", {
						description: `O utilizador ${data.username} foi criado com sucesso.`,
						duration: 2000,
					});
			...
			api
				...
				.then((response) => {
					...
					toast.info("Utilizador editado", {
						description: `O utilizador ${old_data.username} foi editado com sucesso.`,
						duration: 2000,
					});
					resolve(response);
				})
			...
			api
				...
				.then((response) => {
					...
					toast.info("Utilizador apagado", {
						description: `O utilizador ${data.username} foi apagado com sucesso.`,
						duration: 2000,
					});
					resolve(response);
				})
